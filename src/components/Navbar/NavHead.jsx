...
function Header() {
    ...
    return (
      <header className="header w-full relative fixed z-10">
        <div className='bg-my-red flex justify-center py-3'>
          <div className='w-11/12 flex sm:flex justify-between gap-3 md:gap-4 items-center'>
            <p className='italic font-bold font-my_font text-white'>Raising Godly Seeds</p>
